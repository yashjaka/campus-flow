...
export default function AdminDashboard() {
  ...
  const maintenanceCount = allUsers.filter(
  ...
  const statsCards = [
    ...
    },
    {
      label: "Events",
      value: eventCount,
      sub: `${noticeCount} notices published`,
      icon: BookOpen,
  ...
  const quickLinks = [
    {
      ...
      href: "/complaints",
      icon: MessageSquareWarning,
      desc: `${openIssues.length} open complaints`,
    },
    {
      name: "User Management",
      href: "/admin/users",
      icon: Users,
      desc: `${allUsers.length} total users`,
    },
    {
      name: "Booking Approvals",
      href: "/bookings/manage",
      icon: CalendarDays,
      desc: `${pendingBookings} pending`,
    },
    {
      name: "Notice Board",
      href: "/notices",
      icon: Megaphone,
      desc: `${noticeCount} notices`,
    },
  ];
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Campus administration overview — all systems at a glance.
          </p>
        </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              {issue.studentName} · {issue.location}
                            </p>
                          </div>
                        </div>
