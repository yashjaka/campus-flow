...
export default function LandingPage() {
  ...
  const [previewTab, setPreviewTab] = useState<"student" | "faculty" | "admin">(
    "student",
  );
  ...
  const fillDemo = (
    email: string,
    pass: string,
    role: "faculty" | "maintenance" | "admin",
  ) => {
  ...
  const features = [
    {
      ...
      desc: "Report maintenance or plumbing requests. Categorized and dispatched instantly.",
      color: "text-purple-400",
    },
    {
      icon: AlertTriangle,
      title: "Emergency SOS Reporting",
      desc: "Panic medical, fire, or security buttons broadcasting location coordinates to security.",
      color: "text-red-400",
    },
    {
      icon: Search,
      title: "Lost & Found Board",
      desc: "Browse items, search locations, and post lost property notifications with photos.",
      color: "text-blue-400",
    },
    {
      icon: Calendar,
      title: "Resource Booking",
      desc: "Reserve computer labs, auditorium, and audio equipment with automated conflict checking.",
      color: "text-emerald-400",
    },
    {
      icon: Sparkles,
      title: "Event Hub",
      desc: "Explore campus workshops, hackathons, and guest lectures. RSVP and save to calendar.",
      color: "text-yellow-400",
    },
    {
      icon: Megaphone,
      title: "Digital Notice Board",
      desc: "Read verified academic notifications, placement updates, and exam circulars.",
      color: "text-cyan-400",
    },
    {
      icon: MessageSquare,
      title: "Student Feedback",
      desc: "Engage in class reviews, surveys, and campus feedback assessments.",
      color: "text-orange-400",
    },
    {
      icon: BarChart3,
      title: "Analytics Dashboard",
      desc: "Detailed statistics on issue resolution times, response rates, and resource utilization.",
      color: "text-pink-400",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "The emergency SOS panic button was critical when a classmate fainted. Campus response teams arrived within 3 minutes.",
      author: "Arjun Verma",
      role: "Undergrad Student",
    },
    {
      quote:
        "Booking lab resources used to require physical forms and days of approvals. Now I schedule project space in 15 seconds.",
      author: "Ananya Bose",
      role: "B.Tech Final Year",
    },
    {
      quote:
        "It helps my maintenance team track water leaks and socket faults at a glance. Communication is streamlined and rapid.",
      author: "Carlos Rivera",
      role: "Facilities Crew Supervisor",
    },
    {
      quote:
        "Publishing exam schedules and class changes has never been easier. I can reach the entire student registry in seconds.",
      ...
      <div className="flex flex-col min-h-screen text-foreground select-none relative z-10">
        ...
        <header className="glass-nav sticky top-0 px-6 py-4 flex justify-between items-center z-50 transition-all border-b border-white/5">
          ...
          <div className="flex gap-3">
            <Button
              variant="ghost"
              className="text-sm font-semibold border border-white/10"
              onClick={() => setStaffModalOpen(true)}
            >
              Staff/Admin Login
            </Button>
            <Button
              className="bg-primary hover:bg-primary/95 text-primary-foreground text-sm font-semibold glow-primary"
        ...
        <section
          id="hero"
          className="flex-1 flex flex-col items-center justify-center pt-24 pb-16 px-6 text-center max-w-5xl mx-auto relative z-20"
        >
          <motion.div
          ...
          >
            ...
            <p className="text-md sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              An elegant, all-in-one operating platform for universities.
              Seamlessly connect students, faculty, and administration to report
              issues, book facilities, and manage campus alerts.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-primary hover:bg-primary/95 text-primary-foreground font-bold px-8 py-6 rounded-xl text-md glow-primary group"
                onClick={() => setStudentModalOpen(true)}
              >
                Get Student Access
              ...
              <Button
                size="lg"
                variant="secondary"
                className="w-full sm:w-auto font-bold border border-white/10 px-8 py-6 rounded-xl text-md"
                onClick={() => setStaffModalOpen(true)}
              >
                Staff & Admin Portal
              </Button>
        ...
        <section
          id="features"
          className="py-24 max-w-6xl mx-auto px-6 relative z-20"
        >
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-md">
              Ditch papers and emails. CampusFlow unifies every operational
              request, announcement, and event under one modern interface.
            </p>
          </div>
              ...
              >
                <Card className="glass-card h-full border-white/5 hover:border-white/10 hover:shadow-lg transition-shadow overflow-hidden group">
                  <CardHeader className="pb-2">
                    <div
                      className={`w-11 h-11 rounded-lg bg-white/5 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform`}
                    >
        ...
        <section
          id="previews"
          className="py-20 bg-black/10 border-t border-white/5 relative z-20"
        >
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12 space-y-4">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-md">
                Experience role-tailored dashboards built with beautiful
                widgets, analytics tables, and dark mode aesthetics.
              </p>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="p-4 rounded-xl bg-purple-500/5 border border-purple-500/10">
                        ...
                        <h4 className="font-bold text-sm">
                          Ceiling Leakage CE-102
                        </h4>
                        <span className="inline-flex items-center text-[10px] px-2 py-0.5 rounded-full mt-2 font-bold bg-orange-500/20 text-orange-400">
                          In Progress
                        </span>
                      </div>
                      <div className="p-4 rounded-xl bg-red-500/5 border border-red-500/10">
                        ...
                        <span className="inline-flex items-center text-[10px] px-2 py-0.5 rounded-full mt-2 font-bold bg-red-500/20 text-red-400">
                          Dispatched
                        </span>
                      </div>
                      <div className="p-4 rounded-xl bg-blue-500/5 border border-blue-500/10">
                        ...
                        <span className="inline-flex items-center text-[10px] px-2 py-0.5 rounded-full mt-2 font-bold bg-emerald-500/20 text-emerald-400">
                          Approved
                        </span>
                      </div>
                    </div>
                          ...
                          <div className="p-3 rounded bg-black/25 flex justify-between items-center text-xs">
                            <div>
                              <p className="font-semibold">
                                Auditorium - Drama Rehearsal
                              </p>
                              <p className="text-[10px] text-muted-foreground">
                                Requested by: Priya Sharma
                              </p>
                            </div>
                            <div className="flex gap-2">
                              <span className="px-2 py-1 bg-green-500/10 text-green-400 rounded cursor-pointer font-bold">
                                Approve
                              </span>
                              <span className="px-2 py-1 bg-red-500/10 text-red-400 rounded cursor-pointer font-bold">
                                Reject
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="space-y-1.5 text-xs">
                        <div className="flex gap-2 text-muted-foreground py-1 border-b border-white/5">
                          ...
                          <span className="text-foreground">
                            Student Arjun Verma reported AC malfunction in IT
                            Lab 2
                          </span>
                        </div>
                        <div className="flex gap-2 text-muted-foreground py-1 border-b border-white/5">
                          ...
                          <span className="text-foreground">
                            Admin registered new faculty member Dr. MITchell
                          </span>
                        </div>
                      </div>
                    </div>
        ...
        <section className="py-24 max-w-5xl mx-auto px-6 relative z-20">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-md">
              Trace the automated lifecycle of an reported campus issue from
              inception to final feedback resolution.
            </p>
          </div>
          ...
          <div className="space-y-10 relative before:absolute before:inset-0 before:left-5 md:before:left-1/2 before:w-0.5 before:bg-white/10 before:h-full">
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-0 pl-10 md:pl-0">
              <div className="md:w-5/12 md:text-right">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  A student snaps a picture and submits a complaint with
                  category tagging.
                </p>
              </div>
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-0 pl-10 md:pl-0">
              ...
              <div className="md:w-5/12">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Campus admin reviews details and assigns a response officer or
                  maintenance worker.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-0 pl-10 md:pl-0">
              <div className="md:w-5/12 md:text-right">
                ...
                <h4 className="text-xl font-bold mb-2">
                  Staff Resolves Problem
                </h4>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Faculty or maintenance staff carries out repairs and posts
                  resolution comments.
                </p>
              </div>
              <div className="absolute left-3.5 md:left-1/2 -translate-x-1/2 w-4.5 h-4.5 rounded-full border-4 border-black bg-primary glow-primary flex items-center justify-center z-10" />
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-0 pl-10 md:pl-0">
              ...
              <div className="md:w-5/12">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Student receives a real-time notification, reviews the work,
                  and rates the experience.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="testimonials"
          className="py-24 border-t border-white/5 relative z-20"
        >
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16 space-y-4">
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight">
                Loved by{" "}
                <span className="gradient-text">students and staff.</span>
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-md">
                Here's what our campus residents say about the digital
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {testimonials.map((t, idx) => (
                <Card
                  key={idx}
                  className="glass-card border-white/5 p-4 flex flex-col justify-between h-full bg-black/20"
                >
        ...
        <section className="py-24 text-center px-6 border-t border-white/5 relative overflow-hidden z-20">
          ...
          >
            ...
            <p className="text-sm sm:text-md text-muted-foreground max-w-xl mx-auto">
              Digitize classrooms, asset bookings, and maintenance operations.
              Join today to unlock seamless campus integration.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/95 text-primary-foreground font-bold px-8 py-6 rounded-xl text-md glow-primary"
                onClick={() => setStudentModalOpen(true)}
              >
                Enter as Student
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="font-bold border border-white/10 px-8 py-6 rounded-xl text-md"
                onClick={() => setStaffModalOpen(true)}
              >
        ...
        <footer className="py-8 text-center text-xs text-muted-foreground border-t border-white/5 z-20 bg-black/40">
          © {new Date().getFullYear()} CampusFlow Systems. Designed for
        ...
        <Dialog open={studentModalOpen} onOpenChange={setStudentModalOpen}>
          <DialogContent className="glass-card border border-white/10 sm:max-w-[420px] bg-black/90 backdrop-blur-lg shadow-2xl p-6">
            <DialogHeader className="text-center pb-2">
              ...
              <DialogDescription>
                Provide details below. If your enrollment is not pre-registered,
                we will auto-generate your profile for the demo.
              </DialogDescription>
            </DialogHeader>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                {studentForm.formState.errors.enrollmentNumber && (
                  <p className="text-[10px] text-red-400 font-semibold">
                    {studentForm.formState.errors.enrollmentNumber.message}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-1">
                ...
                {studentForm.formState.errors.collegeName && (
                  <p className="text-[10px] text-red-400 font-semibold">
                    {studentForm.formState.errors.collegeName.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  {studentForm.formState.errors.department && (
                    <p className="text-[10px] text-red-400 font-semibold">
                      {studentForm.formState.errors.department.message}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <Select
                    onValueChange={(val) =>
                      studentForm.setValue("semester", val)
                    }
                    defaultValue={studentForm.getValues("semester")}
                  >
            ...
            <div className="mt-4 pt-4 border-t border-white/5 text-center">
              <span
                className="text-[10px] text-muted-foreground cursor-pointer hover:text-white"
        ...
        <Dialog open={staffModalOpen} onOpenChange={setStaffModalOpen}>
          <DialogContent className="glass-card border border-white/10 sm:max-w-[420px] bg-black/90 backdrop-blur-lg shadow-2xl p-6">
            <DialogHeader className="text-center pb-2">
              ...
              <DialogDescription>
                Sign in with your email. Select your institutional role to
                proceed.
              </DialogDescription>
            </DialogHeader>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <Select
                  onValueChange={(val) =>
                    staffForm.setValue("role", val as any)
                  }
            ...
            <div className="mt-4 pt-4 border-t border-white/5 space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                <Button
                  variant="outline"
                  className="text-[9px] h-7 px-1 bg-white/5"
                  onClick={() =>
                    fillDemo("admin@campusflow.demo", "admin123", "admin")
                  }
                >
                  🛡️ Admin
                </Button>
                <Button
                  ...
                  onClick={() =>
                    fillDemo(
                      "sarah.mitchell@campusflow.demo",
                      "faculty123",
                      "faculty",
                    )
                  }
